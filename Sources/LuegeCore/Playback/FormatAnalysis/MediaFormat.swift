...
public enum ContainerFormat: String, Sendable, Equatable, CaseIterable {
    case mp4
    case m4v
    case mov
    case mkv
...
public enum AudioCodec: String, Sendable, Equatable, CaseIterable {
    case aac
    case ac3
    case eac3
    case dts
...
public struct MediaFormat: Sendable, Equatable {
    ...
    public let audioCodecs: [AudioCodec]
    ...
    public var canUseNativePlayer: Bool {
