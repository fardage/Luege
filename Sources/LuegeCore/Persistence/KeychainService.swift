...
public final class KeychainService: CredentialStoring, @unchecked Sendable {
    ...
    public init(serviceName: String = "com.luege.credentials", accessGroup: String? = nil) {
        self.serviceName = serviceName
        self.accessGroup = accessGroup
    }

    public func store(_ credentials: ShareCredentials, for id: UUID) throws {
    ...
    public func retrieve(for id: UUID) throws -> ShareCredentials? {
        let key = keychainKey(for: id)
