...
public actor SavedShareStorageService: SharePersisting {
    ...
    public var savedShares: [SavedShare] {
        cachedShares
    }
    ...
    public func delete(_ share: SavedShare) async throws {
    ...
    public func loadAll() async throws -> [SavedShare] {
    ...
    public func exists(hostAddress: String, shareName: String) -> Bool {
